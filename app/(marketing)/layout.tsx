          ...
          <header className="marketing-header border-b border-slate-100 bg-white">
            <div className="marketing-header-inner mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-5 py-3.5 sm:px-6 sm:py-4">
              ...
              <div className="marketing-theme-actions flex items-center gap-2">
                <Link
                  href="/request-access"
                  className="marketing-access-link inline-flex items-center justify-center rounded-full border border-black bg-transparent px-4 py-2 text-sm font-semibold text-black transition hover:bg-black hover:text-white sm:px-5"
                >
                  Request Access
                </Link>
                <Link
                  href="/login"
                  className="marketing-login-link inline-flex items-center justify-center rounded-full border border-black bg-transparent px-4 py-2 text-sm font-semibold text-black transition hover:bg-black hover:text-white sm:px-5"
                >
                  Login
                </Link>
              </div>
